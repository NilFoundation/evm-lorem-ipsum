...
contract LoremIpsumAccess is SenderStorage, ReceiverStorage, SharedStorage, AccessControlUpgradeable {
    ...
    modifier onlyAdmin() {
        require(
            ...
            "LoremIpsumRouter: only admin can call this function"
        );
        _;
    }
    ...
    modifier onlyTimelock() {
        require(
            ...
            "LoremIpsumRouter: only timelock can call this function"
        );
        _;
    }
    ...
    modifier onlyGuardian() {
        require(
            ...
            "LoremIpsumRouter: only guardian can call this function"
        );
        _;
    }
    ...
    onlyTimelock
    {
        ...
        lightClients[chainId] = IProtocolState(lightclient);
