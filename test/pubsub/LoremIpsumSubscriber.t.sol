...
contract LoremIpsumSubscriberTest is Test {
    event Subscribe(
    ...
    MockLoremIpsum mockTelepathy;
    LoremIpsumSubscriber telepathySubscriber;
    ...
    function setUp() public {
        mockTelepathy = new MockLoremIpsum(DESTINATION_CHAIN);
        telepathySubscriber = new LoremIpsumSubscriber();
    }
